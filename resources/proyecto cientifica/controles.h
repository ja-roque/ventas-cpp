...
Libreria para controles de formularios
conjunto de funciones que permiten crear
controles para ser usados en formularios

Ruta:	F:\ALGORITMOS Y DAGRAMACION\librerias\controles.h
		L:\ALGORITMOS Y DAGRAMACION\librerias\controles.h
